...
var api100;
(function (api100) {
    let connection = class connection extends Utility_1.Utility.version {
        addConnection(req, res) {
            let _self = this;
            try {
                MongoDb.addConnection(JSON.parse(req.params.connection), function (err, doc) {
                    res.send(200 /* OK */, Utility_1.Utility.Messages.sendObjectMessage(200 /* OK */, 'Connection set to:' + req.params.connection, Utility_1.Utility.method.getMethodName(_self)));
                }, function (e, doc) {
    ...
    ], connection.prototype, "addConnection", null);
    __decorate([
        decorators_1.getMethodName
    ], connection.prototype, "addConnectionAsync", null);
    connection = __decorate([
        decorators_1.Authorization
    ], connection);
    api100.connection = connection;
