    ...
    let Documents = class Documents extends Utility_1.Utility.version {
        PutDocuments(req, res) {
            return __awaiter(this, void 0, void 0, function* () {
                const _self = this;
                const [database, collection, , data] = Utility_1.Utility.params.assign(req);
                try {
                    yield MongoDb.addDocuments(database, collection, data, function (err, doc) {
                        ...
                        res.send(error, Utility_1.Utility.Messages.sendObjectMessage(error, e, Utility_1.Utility.method.getMethodName(_self)));
                    });
                }
                catch (e) {
                    const error = Utility_1.Utility.status.getStatusFromMessage(e);
